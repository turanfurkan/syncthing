            ...
            <div class="content-wrapper">
              ...
              <div class="content-header">
                <div class="container-fluid">
                  <div class="row mb-2">
                    <div class="col-sm-6">
                      <h1 class="m-0 text-dark"><?= stripslashes($kontrol[0]["section_title"]) ?> Ekle</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                      <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="<?= SITE ?>">Anasayfa</a></li>
                        <li class="breadcrumb-item active"><?= stripslashes($kontrol[0]["section_title"]) ?> Ekle</li>
                      </ol>
                    </div><!-- /.col -->
                  </div><!-- /.row -->
                </div><!-- /.container-fluid -->
              ...
              <section class="content">
                ...
                <div class="row">
            <div class="col-md-12">
                                <a href="<?= SITE ?>services/<?=$kontrol[0]["section_id"]?>" class="btn btn-info" style="float:left; margin-bottom:10px; margin-left:10px;"><i class="fas fa-arrow-left"></i> GERİ</a>

              <a href="<?= SITE ?>add-service/<?=$kontrol[0]["section_id"]?>" class="btn btn-success" style="float:right; margin-bottom:10px;"><i class="fa fa-plus"></i> YENİ EKLE</a>
            </div>
          </div>
                  <?php
                  if ($_POST) {
                    if (!empty($_POST["service_title"])) {
                      ...
                      $ekle = $VT->SorguCalistir("INSERT INTO " . "services", "SET lang_id=?, service_table=?, service_title=?, service_description=?, service_image=?, created_date=?", array($lang_id, $kontrol[0]["section_seflink"], $service_title, $service_description, $service_image, date("Y-m-d H:i:s")));
                  ...
                  ?>
                        <div class="alert alert-success">İşleminiz başarıyla kaydedildi.</div><meta http-equiv="refresh" content="0; url=<?= SITE ?>services/<?=$kontrol[0]["section_id"]?>">
                      <?php
                      } else {
                      ?>
